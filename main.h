...
OBOBOB/* from alias.c */
int aliascmd(char **av);
OBOBOBchar *getalias(char *name);
int unsetalias(char *name);
OBOBOB
OBOBOB/* from shellvars.c */
OBOBOBint initsvars(int ac, char **av);
char *getsvar(char *name);
OBOBOBint setsvar(char *name, char *val);
